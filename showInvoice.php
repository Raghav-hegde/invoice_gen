...
<?php include ('header.php'); ?>
		...
		<div class="grid_12"><br><br></div>
                ...
                echo '<div class="grid_12" align = center><br></div>';
 ...
 echo '_________________________________________________________________________________________________________________________________';
				echo '<b><hr/></b>';
 echo '____________________________________________________________________________________<u>Bill Total : '.$invoice_sum.'_______________________________</u>';
                }
                
                }
				echo '<div><br/>';
                    echo '<a href="print.php?id='.$id.'"><center>Print</center></a> ';
                    echo '</div>';
                ?>
